...
# Set up
You will need to have installed julia (at least version 1.8.5) as well as the package [testpackage.jl](https://github.com/igoldsteinh/testpackage.jl) in order to run this code. 
